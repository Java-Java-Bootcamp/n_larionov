...
public class DatabaseServiceImpl implements DatabaseService {
    ...
    private final static String GET_PRODUCTOFER = "select po.id as product_offer_id, \n" +
    ...
    private final static String GET_PRODUCTOFFER_BY_IDS = GET_PRODUCTOFER + "\n" +
            "where po.id in (?)";
    ...
    public List<ProductOfferDto> getProductOfferList() {
        return jdbcTemplate.query(GET_PRODUCTOFER, rowMapper);
    }
